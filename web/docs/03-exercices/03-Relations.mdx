...
1. Ouvrir le prompt de commande (PAS powershell) avec touche windows + r, écrire cmd et faire enter
2. Taper la commande suivante: echo %USERPROFILE%\dotnet\tools

| ![alt text](image-9.png) |
|-|

3. Copier le réultat (avec votre numéro d'étudiant)
4. Ouvrir l'outil suivant:
...
6. Choisir Path et cliquer sur Modifier...

| ![alt text](image-12.png) |
|-|

7. Cliquer sur Nouveau et copier le path que vous avez obtenu avec echo

| ![alt text](image-13.png) |
|-|

8. Redémarrer Visual Studio et rouler la commande à nouveau, vous devriez réussir à générer le contrôleur!
