...
:::warning
Le UselessTasksController ne prend pas un objet en paramètre pour ces fonctions, c'est un bon moment pour réviser [ceci](/info/TrucsEtRevisions#comment-passer-des-données-avec-une-requête-à-un-serveur-web)!
:::
