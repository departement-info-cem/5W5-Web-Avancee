...
## Défis
- Avoir le même modèle de données, réglé en effectuant les modifications au modèle en premier
...
## TODO
- MOI: Fixer: Afficher les cartes correctement lorsqu'on achète un paquet
- MOI: Afficher les pouvoirs autant sur le battlefield que dans le magasin
- Moi: Fournir les tests
- MOI: Tester l'ajout des tests à un bon projet remis
- MOI: Figurer comment je gère le GameConfig pour les tests!

- MOI: Obfusquer le code

- MOI: Montrer des animations de base pour la fin du TP2
- MOI: Parler des sprints
...
- Changements au modèle (pour satisfaire à toutes les tâches individuelles de votre équipe)
- Ajout des méthodes suivantes à la classe PlayableCard
