...
:::danger
Mais il faut respecter les [règles](/docs/04-tps/02-UtilisationIA.md)!
:::
...
Vous pouvez consulter la documentation de Mermaid si vous le désirez : [Diagrammes Mermaid](https://mermaid.js.org/syntax/classDiagram.html).

Un autre [outil](https://www.mermaideditor.io/) plus simple pour voir votre diagramme.
...
Groupe A26 1010:
[Serveur départ](https://classroom50.org/CEM-420-5W5-TPS/a26-1010/assignments/sci/accept)
[Client départ](https://classroom50.org/CEM-420-5W5-TPS/a26-1010/assignments/react-sci/accept)


Groupe A26 1020:
[Serveur départ](https://classroom50.org/CEM-420-5W5-TPS/a26-1020/assignments/sci/accept)
[Client départ](https://classroom50.org/CEM-420-5W5-TPS/a26-1020/assignments/react-sci/accept)
...
- Ajouter les events `DrawCardEvent` dans `StartMatchEvent`.
...
- Ajouter la logique pour les méthodes `JoinMatch`, `StopJoiningMatch`, `EndTurn` et `Surrender` qui vont utiliser les méthodes du même nom qui existe dans **MatchesService** sur le Hub et il faut ensuite les utiliser avec le client.
(ATTENTION: Il y a un annexe à la fin de cette page avec plus d'informations à propos de la logique de connexion à un match.)
- Une fois la tâche terminée on peut faire une partie avec **deux** clients, donc:
...
Option 3x3
| ![Image 3x3](image-7.png) |
| --- |

Option 4x4
| ![Image 4x4](image-6.png) |
| --- |
...
- Ajouter la logique pour **GainManaEvent** dans **applyEvent** de **match-context.tsx** . (Vous allez maintenant voir le mana qui monte au début du tour)
