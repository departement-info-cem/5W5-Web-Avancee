...
- Diagramme de classes et GetPlayerCards() (Remise à la **Rencontre 3.2**)
...
#### Faire fonctionner GetPlayerCards

<!-- TODO: Compléter ce qui doit être fait pour GetPlayerCards -->
C'est une méthode centrale qui est utilisée dans toutes les parties du projet
