...
Il y a 2 évaluations, mais c'est votre responsabilité de terminer votre tâches individuelle au moins une semaine avant la remise d'équipe pour donner du temps à votre équipe pour terminer la partie en équipe:
...
Ajouter cette méthode à la classe `Card`
...
- Pour que les [tests fournis](https://github.com/CEM-420-5W5/Tests_sci) compilent, il faut avoir déjà ajouté les classes nécessaires qui sont mentionnées plus haut.
...
### Les tâches individuelles
- **\[Obligatoire\]** Logique de jeu
- **\[Obligatoire\]** Achat de paquets de cartes
- **\[Obligatoire\]** Animations???
- MVC - Ajout des pouvoirs (Powers)
...
TODO: Mettre à jour le lien du client
- 🔗[Client React](https://ngsci.onrender.com/)
