...
Détails de notre système ELO:
    ...
    - Après chaque match on utilise la méthode de calcul de ELO (fournie plus bas) qui va mettre à jour le score des 2 joueurs.
      - Le joueur qui a **gagné** voit son score **augmenté**
      - Le joueur qui a **perdu** voit son score **diminué**
...
- Afficher un message dans l'écran lorsqu'un spectacteur se joint à une partie (Afficher son nom ou email)
