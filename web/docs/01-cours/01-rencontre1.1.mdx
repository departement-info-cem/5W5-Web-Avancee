...
import Rencontre_1_1 from './Rencontre_1_1';
...
Comme le niveau de l'IA est semblable à celui d'un programmeur expérimenté, il est incroyablement utile pour un programmeur qui a lui même de l'expérience!
