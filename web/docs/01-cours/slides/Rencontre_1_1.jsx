  ...
  return (
    <div className="slides">
      ...
      <section data-background-gradient="linear-gradient(to bottom, #141e30, #243b55)">
        ...
        <li>Nouvelles fonctionnalités React et .Net</li>
      ...
      <section data-background-gradient="linear-gradient(to bottom, #141e30, #243b55)">
        <h3>Origine</h3>
        <SlideImage src="/img/slides/Rencontre_1_1/07-2.png" style={{maxWidth: "55%", paddingBottom: "1rem", paddingTop: "1rem"}} />
        <SlideImage src="/img/slides/Rencontre_1_1/07-1.png" style={{maxWidth: "55%"}} />
